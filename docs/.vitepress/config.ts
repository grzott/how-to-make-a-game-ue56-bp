...
export default defineConfig({
  ...
  { text: "Enhanced Input Advanced Features", link: "/guide/enhanced-input-advanced-features" },
  ...
  { text: "GAS Advanced Patterns", link: "/guide/gameplay-ability-system-advanced" },
  ...
  { text: "World-Scale Seamless Architecture", link: "/guide/world-streaming-seamless-architecture" },
  ...
  { text: "Testing & Automation Advanced", link: "/guide/testing-automation-advanced" },
      ],
      "/llm/": [
